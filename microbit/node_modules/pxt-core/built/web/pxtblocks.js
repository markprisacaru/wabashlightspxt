...
(function (pxt) {
    ...
    (function (blocks_1) {
        ...
        function compileSet(e, b, comments) {
            ...
            return blocks_1.mkStmt(blocks_1.mkText(isDef ? "let " : ""), blocks_1.mkText(binding.escapedName + " = "), expr);
        }
            ...
            function trackVariables(block, currentScope, e) {
                ...
                if (hasStatementInput(block)) {
                    ...
                    if (vars.length) {
                        ...
                        parentScope_1 = currentScope.firstStatement === block ? currentScope : {
                            parent: currentScope,
        ...
        function markDeclarationLocations(scope, e) {
            ...
            if (declared.length) {
                ...
                if (scope.firstStatement) {
                    ...
                    pxt.Util.assert(!e.blockDeclarations[scope.firstStatement.id]);
