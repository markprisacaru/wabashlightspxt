...
switch (step) {
  case 0:
    ...
    r0 = pxsim.Array_.mk();
    s.tmp_0 = r0;
    r0 = pxsim.Array_.push(s.tmp_0, inline__P536);
  ...
  case 2:
    r0 = s.retval;
    r0 = pxsim.input.onLoudSound(inline__P529);
    return leave(s, r0)
  default: oops()
} } }
...
switch (step) {
  case 0:
    ...
    s.level___528 = undefined;
    r0 = pxsim.input.soundLevel();
    s.tmp_0 = r0;
    r0 = s.level___528;
    r0 = s.tmp_0;
    s.level___528 = (r0);
    s.tmp_0 = { fn: logValue__P176, parent: s };
    r0 = "sound";
    s.tmp_0.arg0 = r0;
    r0 = s.level___528;
    s.tmp_0.arg1 = r0;
...
inline__P527.info = {"start":8,"length":81,"line":0,"column":8,"endLine":3,"endColumn":1,"fileName":"test.ts","functionName":"inline"}



var inline__P529  = function (s) {
var r0 = s.r0, step = s.pc;
s.pc = -1;
...
inline__P529.info = {"start":109,"length":33,"line":4,"column":18,"endLine":6,"endColumn":1,"fileName":"test.ts","functionName":"inline"}
...
inline__P536.info = {"start":534,"length":85,"line":25,"column":8,"endLine":25,"endColumn":93,"fileName":"pxt_modules/base/console.ts","functionName":"inline"}



var logValue__P176  = function (s) {
var r0 = s.r0, step = s.pc;
s.pc = -1;
...
switch (step) {
  ...
  case 1:
    ...
    setupResume(s, 6);
    pxsim.String_.stringConv(s.tmp_9);
    checkResumeConsumed();
    return;
  ...
  case 6:
    r0 = s.retval;
    s.tmp_10 = r0;
    r0 = pxsim.String_.concat(s.tmp_8, s.tmp_10);
    { step = 2; continue; }
  case 2:
    // jmp value (already in r0)
    s.tmp_11 = r0;
    s.tmp_12 = { fn: log__P175, parent: s };
    r0 = s.tmp_11;
    s.tmp_12.arg0 = r0;
    s.pc = 7;
...
logValue__P176.info = {"start":1837,"length":120,"line":69,"column":4,"endLine":71,"endColumn":5,"fileName":"pxt_modules/base/console.ts","functionName":"logValue"}
